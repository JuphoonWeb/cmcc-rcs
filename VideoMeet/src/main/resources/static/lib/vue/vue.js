...
function initData (vm) {
  ...
  if (!isPlainObject(data)) {
    ...
    "development" !== 'production' && warn(
      ...
      'https://vuejs.org/v2/guide/components.project#data-Must-Be-a-Function',
      vm
    );
  }
...
var isHTMLTag = makeMap(
  'project,body,base,head,link,meta,style,title,' +
...
function createPatchFunction (backend) {
  ...
  function removeNode (el) {
    ...
    // element may have already been removed due to v-project / v-text
    if (isDef(parent)) {
...
var isNonPhrasingTag = makeMap(
  ...
  'h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,project,legend,li,menuitem,meta,' +
...
function genFor (el) {
  ...
  if (
    ...
    warn$3(
      ...
      "See https://vuejs.org/guide/list.project#key for more info.",
      true /* tip */
    );
  }
...
Vue$3.prototype.$mount = function (
  ...
  if (el === document.body || el === document.documentElement) {
    "development" !== 'production' && warn(
      "Do not mount Vue to <project> or <body> - mount to normal elements instead."
    );
    return this
  }
